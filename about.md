    ...
    <div id="navbar-desctop" class="is-navbar is-hidden-mobile">
        ...
        <nav>
            <ul>
                ...
                <li><a href="{{ site.url }}/about"><b>о нас</b></a></li>
            </ul>
        </nav>
...
<div class='content'>
    <div style="width: 100%; height: 75vh; background: url('{{ site.url }}/img/about.jpg'); background-position: center;background-size: cover; background-position: middle center; margin-bottom: 50px; position: relative;">
